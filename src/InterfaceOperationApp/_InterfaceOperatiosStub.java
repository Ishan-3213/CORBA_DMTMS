...
/**
* InterfaceOperationApp/_InterfaceOperatiosStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ./InterfaceOperations.idl
* Friday, February 24, 2023 11:20:09 AM EST
*/

public class _InterfaceOperatiosStub extends org.omg.CORBA.portable.ObjectImpl implements InterfaceOperationApp.InterfaceOperatios
{
  ...
  public String exchangeMovieTickets (String customerID, String movieId, String movieName, String new_movieId, String new_movieName, int numberOfTickets)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("exchangeMovieTickets", true);
                $out.write_string (customerID);
                $out.write_string (movieId);
                $out.write_string (movieName);
                ...
                return exchangeMovieTickets (customerID, movieId, movieName, new_movieId, new_movieName, numberOfTickets        );
            } finally {
                _releaseReply ($in);
            }
  } // exchangeMovieTickets
